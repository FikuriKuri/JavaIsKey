...
public class Game {
    ...
    public void turnStart(){
        ...
        if(moves % 2 == 0) System.out.println("Human's Turn!");
    ...
    public void roundRecord(int round){
        ...
        try{
            ...
            writer.write("Round " + round + " Record\n");
            writer.write("Moves taken : " + moves + "\n");
            
            //Identify who is the winner by checking who does the last turn on that round.
            String winner;
            if((moves-1)% 2 == 0)  winner = "Human";
            else winner = "Monster";
    ...
    private static void displayMenu(){
        String filePath = "GameCohort/turnMenu.txt";
